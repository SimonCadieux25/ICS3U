package cadieux;
/* BingoCardPart2.java
 * Prints out the rules for bingo
 * September 14 2016
 * Simon Cadieux
 */
public class BingoCardPart2 {

	public static void main(String[] args) {
		System.out.println("Bingo Card\n");
		System.out.println("1. The Caller randomly pulls a nummbered bingo ball.\n");
		...
		System.out.println("5. Steps 1 to 4 are repeated untill a player maches the BINGO patern.\n");
